  ...
  return (
    <div className="max-w-[80vw] xl:max-w-[50vw] mt-0 flex flex-col gap-8">
      <div className="mb-4 flex min-w-full">
        ...
        <h1 className="mt-8 text-5xl font-black md:ml-8">
      ...
      <p className="text-lg mb-4">
        ...
        of ratings, reviews, and lists, their profile quickly becomes a central
        hub for their life in music.
      </p>
      <div className="mb-4 flex min-w-full">
        <h1 className="mr-8 mt-8 text-5xl font-black">Our vision </h1>
        <div className="">
          <Image
            width={400}
            height={400}
